    ...
    while (endLine < childCount) {
        ...
        if (flexibleChildrenCount != 0) {
            ...
            while (currentFlexChild != NULL) {
                ...
                if (currentFlexChild->style.flex > 0 && currentFlexChild->children_count == 0) {
                    if (isUndefined(currentFlexChild->layout.dimensions[1])) {
                        currentFlexChild->layout.dimensions[1] = currentFlexChild -> layout.dimensions[0];
                    }
                    
                    if (isUndefined(currentFlexChild->layout.dimensions[0] )) {
                        currentFlexChild->layout.dimensions[0] = currentFlexChild -> layout.dimensions[1];
                    }
                }
        ...
        for (i = firstComplexMain; i < endLine; ++i) {
            ...
            if (child->style.position_type == CSS_POSITION_ABSOLUTE &&
                ...
                if (isMainDimDefined) {
                    ...
                    if (node->style.justify_content == CSS_JUSTIFY_SPACE_AROUND && isFlex(child) && node->children_count == 1) {
                        child->layout.position[trailing[mainAxis]] = child->layout.position[trailing[mainAxis]] / 2;
                        child->layout.position[leading[mainAxis]] = child->layout.position[trailing[mainAxis]];
                    }
                }
